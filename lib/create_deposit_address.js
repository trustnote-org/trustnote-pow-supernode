...
function createMinerDepositAddress(my_address, amount, callback) {
	...
	deposit.hasInvalidUnitsFromHistory(null, my_address, function(err, hasInvalid) {
		if(err) {
			...
			onError("Your address had invalid joints. If you still want to be a miner, please create new joint or use other mnemonic codes")
		}
		deposit.createDepositAddress(my_address, {
			ifError: onError,
